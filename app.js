...
const myMiddleWare2=require('./middlewares/middle1');

//get,post,put,delete

app.use(express.json());

app.use(myMiddleWare);  //I am custom middleware

app.use(myMiddleWare2); //I am second middleware

app.use(morgan('tiny'));    //GET /courses 200 78 - 5.215 ms
